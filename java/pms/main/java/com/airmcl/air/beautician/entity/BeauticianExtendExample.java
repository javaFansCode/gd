...
public class BeauticianExtendExample extends AbstractExample<BeauticianExtend> implements Serializable {
    ...
    protected PageView<BeauticianExtend> pageView = new PageView<BeauticianExtend>(1, 10);

    private static final long serialVersionUID = 1L;

    public BeauticianExtendExample() {
    ...
    @Override
    public PageView<BeauticianExtend> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<BeauticianExtend> pageView) {
