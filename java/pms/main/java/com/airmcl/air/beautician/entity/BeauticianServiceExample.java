...
public class BeauticianServiceExample extends AbstractExample<BeauticianService> implements Serializable {
    ...
    protected PageView<BeauticianService> pageView = new PageView<BeauticianService>(1, 10);

    private static final long serialVersionUID = 1L;

    public BeauticianServiceExample() {
    ...
    @Override
    public PageView<BeauticianService> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<BeauticianService> pageView) {
