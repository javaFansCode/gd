...
public class StartpageExample extends AbstractExample<Startpage> implements Serializable {
    ...
    protected PageView<Startpage> pageView = new PageView<Startpage>(1, 10);

    private static final long serialVersionUID = 1L;

    public StartpageExample() {
    ...
    @Override
    public PageView<Startpage> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<Startpage> pageView) {
