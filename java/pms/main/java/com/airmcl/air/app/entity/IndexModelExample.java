...
public class IndexModelExample extends AbstractExample<IndexModel> implements Serializable {
    ...
    protected PageView<IndexModel> pageView = new PageView<IndexModel>(1, 10);

    private static final long serialVersionUID = 1L;

    public IndexModelExample() {
    ...
    @Override
    public PageView<IndexModel> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<IndexModel> pageView) {
