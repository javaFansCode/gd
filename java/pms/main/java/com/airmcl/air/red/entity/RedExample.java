...
public class RedExample extends AbstractExample<Red> implements Serializable {
    ...
    protected PageView<Red> pageView = new PageView<Red>(1, 10);
    ...
    @Override
    public PageView<Red> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<Red> pageView) {
