...
public class RedEventExample extends AbstractExample<RedEvent> implements Serializable {
    ...
    protected PageView<RedEvent> pageView = new PageView<RedEvent>(1, 10);

    private static final long serialVersionUID = 1L;

    public RedEventExample() {
    ...
    @Override
    public PageView<RedEvent> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<RedEvent> pageView) {
