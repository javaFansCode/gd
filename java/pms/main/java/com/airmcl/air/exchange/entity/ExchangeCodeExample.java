...
public class ExchangeCodeExample extends AbstractExample<ExchangeCode> implements Serializable {
    ...
    protected PageView<ExchangeCode> pageView = new PageView<ExchangeCode>(1, 10);
    ...
    @Override
    public PageView<ExchangeCode> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ExchangeCode> pageView) {
