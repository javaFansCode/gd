...
public class OrderChangeExample extends AbstractExample<OrderChange> implements Serializable {
    ...
    protected PageView<OrderChange> pageView = new PageView<OrderChange>(1, 10);

    private static final long serialVersionUID = 1L;

    public OrderChangeExample() {
    ...
    @Override
    public PageView<OrderChange> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<OrderChange> pageView) {
