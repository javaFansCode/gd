...
public class OrderActionExample extends AbstractExample<OrderAction> implements Serializable {
    ...
    protected PageView<OrderAction> pageView = new PageView<OrderAction>(1, 10);
    ...
    @Override
    public PageView<OrderAction> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<OrderAction> pageView) {
