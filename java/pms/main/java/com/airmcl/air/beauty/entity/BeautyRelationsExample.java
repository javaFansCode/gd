...
public class BeautyRelationsExample extends AbstractExample<BeautyRelations> implements Serializable {
    ...
    protected PageView<BeautyRelations> pageView = new PageView<BeautyRelations>(1, 10);

    private static final long serialVersionUID = 1L;

    public BeautyRelationsExample() {
    ...
    @Override
    public PageView<BeautyRelations> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<BeautyRelations> pageView) {
