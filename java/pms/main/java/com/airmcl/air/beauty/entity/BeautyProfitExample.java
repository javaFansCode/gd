...
public class BeautyProfitExample extends AbstractExample<BeautyProfit> implements Serializable {
    ...
    protected PageView<BeautyProfit> pageView = new PageView<BeautyProfit>(1, 10);

    private static final long serialVersionUID = 1L;

    public BeautyProfitExample() {
    ...
    @Override
    public PageView<BeautyProfit> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<BeautyProfit> pageView) {
