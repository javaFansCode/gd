...
@Deprecated
public class GoodsLedgerRuleExample extends AbstractExample<GoodsLedgerRule> implements Serializable {
    ...
    protected PageView<GoodsLedgerRule> pageView = new PageView<GoodsLedgerRule>(1, 10);

    private static final long serialVersionUID = 1L;

    public GoodsLedgerRuleExample() {
    ...
    @Override
    public PageView<GoodsLedgerRule> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<GoodsLedgerRule> pageView) {
