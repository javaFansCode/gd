...
public class ServiceCityExample extends AbstractExample<ServiceCity> implements Serializable {
    ...
    protected PageView<ServiceCity> pageView = new PageView<ServiceCity>(1, 10);

    private static final long serialVersionUID = 1L;

    public ServiceCityExample() {
    ...
    @Override
    public PageView<ServiceCity> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ServiceCity> pageView) {
