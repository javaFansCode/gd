...
public class ServiceHomeBuyExample extends AbstractExample<ServiceHomeBuy> implements Serializable {
    ...
    protected PageView<ServiceHomeBuy> pageView = new PageView<ServiceHomeBuy>(1, 10);

    private static final long serialVersionUID = 1L;

    public ServiceHomeBuyExample() {
    ...
    @Override
    public PageView<ServiceHomeBuy> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ServiceHomeBuy> pageView) {
