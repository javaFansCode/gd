...
public class ServiceTypeEquipmentExample extends AbstractExample<ServiceTypeEquipment> implements Serializable {
    ...
    protected PageView<ServiceTypeEquipment> pageView = new PageView<ServiceTypeEquipment>(1, 10);

    private static final long serialVersionUID = 1L;

    public ServiceTypeEquipmentExample() {
    ...
    @Override
    public PageView<ServiceTypeEquipment> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ServiceTypeEquipment> pageView) {
