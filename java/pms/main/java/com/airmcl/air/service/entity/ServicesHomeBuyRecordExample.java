...
public class ServicesHomeBuyRecordExample extends AbstractExample<ServicesHomeBuyRecord> implements Serializable {
    ...
    protected PageView<ServicesHomeBuyRecord> pageView = new PageView<ServicesHomeBuyRecord>(1, 10);

    private static final long serialVersionUID = 1L;

    public ServicesHomeBuyRecordExample() {
    ...
    @Override
    public PageView<ServicesHomeBuyRecord> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ServicesHomeBuyRecord> pageView) {
