...
public class GoodsRelationsExample extends AbstractExample<GoodsRelations> implements Serializable {
    ...
    protected PageView<GoodsRelations> pageView = new PageView<GoodsRelations>(1, 10);

    private static final long serialVersionUID = 1L;

    public GoodsRelationsExample() {
    ...
    @Override
    public PageView<GoodsRelations> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<GoodsRelations> pageView) {
