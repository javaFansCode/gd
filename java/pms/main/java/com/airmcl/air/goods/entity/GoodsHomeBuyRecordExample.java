...
public class GoodsHomeBuyRecordExample extends AbstractExample<GoodsHomeBuyRecord> implements Serializable {
    ...
    protected PageView<GoodsHomeBuyRecord> pageView = new PageView<GoodsHomeBuyRecord>(1, 10);

    private static final long serialVersionUID = 1L;

    public GoodsHomeBuyRecordExample() {
    ...
    @Override
    public PageView<GoodsHomeBuyRecord> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<GoodsHomeBuyRecord> pageView) {
