...
public class ActivitysBeautyExample extends AbstractExample<ActivitysBeauty> implements Serializable {
    ...
    protected PageView<ActivitysBeauty> pageView = new PageView<ActivitysBeauty>(1, 10);

    private static final long serialVersionUID = 1L;

    public ActivitysBeautyExample() {
    ...
    @Override
    public PageView<ActivitysBeauty> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<ActivitysBeauty> pageView) {
