...
public class CommentsExtExample extends AbstractExample<CommentsExt> implements Serializable {
    ...
    protected PageView<CommentsExt> pageView = new PageView<CommentsExt>(1, 10);

    private static final long serialVersionUID = 1L;

    public CommentsExtExample() {
    ...
    @Override
    public PageView<CommentsExt> getPageView() {
        return pageView;
    }

    @Override
    public void setPageView(PageView<CommentsExt> pageView) {
